...
dnf5 -y --refresh install brave-browser zed rocminfo rocm-opencl rocm-clinfo rocm-hip distrobox

dnf5 install -y @virtualization virt-manager qemu-kvm libvirt virt-viewer bridge-utils
